...
window.addEventListener("load", function() {
    ...
    */
    ...
    function createPerspective3(pcam, th2, resx, resy) {
        ...
        */
        ...
        function pointToScreen(point) {
            ...
            return [point[0] / (D - point[2]) * proj + resx2, -point[1] / (D - point[2]) * proj + resy2];
        } // pointToScreen
    ...
    Solid.prototype.divideQuadrilateral = function(face, nvertices, nfaces, center) {
            ...
            nfaces.push([norgv, face[0], face[1]], [norgv, face[1], face[2]], [norgv, face[2], face[3]], [norgv, face[3], face[0]]);
    ...
    Solid.prototype.dividePentagon = function(face, nvertices, nfaces, center) {
            ...
            const norgv = nvertices.length;
            nvertices.push(center);
            nfaces.push([norgv, face[0], face[1]], [norgv, face[1], face[2]], [norgv, face[2], face[3]], [norgv, face[3], face[4]], [norgv, face[4], face[0]]);
